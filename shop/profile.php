...
<body>
  ...
  if (isset($_POST["btnsub"])) {
    ...
    if ($_FILES['file']['name'] != "") {
      ...
      if (in_array($fileActualExt, $allow)) {
        if ($fileError == 0) {
          if ($fileSize < 500000) {
            ...
            $fileDestination = "images/shop/" . $fileNameNew;
      ...
      $qry = "update shop set ownername='$tname',contactno='$contactno',email='$temail',sname = '$tsname', address='$address',img='$fileNameNew' where shid='$id'";
      $result = $cnn->query($qry);
      $yourURL = "profile.php";
      echo ("<script>location.href='$yourURL'</script>");
    } else {
      $qry = "update shop set ownername='$tname',contactno='$contactno',email='$temail',sname = '$tsname', address='$address' where shid='$id'";
      $result = $cnn->query($qry);
      if ($result) {
      ...
      <table style="width:100%;">
        ...
        <tr>
          <td>
            ...
            <?php
            if (empty($img)) {
              echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px; background-color: white;'src='images/resources/shop.png '>";
            } else {
              echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/shop/$img'>";
            }
            ?>
        ...
        <tr>
          ...
          <td style="color: grey;">
              Please Upload Photo Of Your Shop <br><br>
          </td>
        </tr>
