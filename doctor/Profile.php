...
<body>
  ...
  if (isset($_POST["btnsub"])) {
    ...
    if ($_FILES['file']['name'] != "") {
      ...
      if (in_array($fileActualExt, $allow)) {
        if ($fileError == 0) {
          if ($fileSize < 500000) {
            ...
            $fileDestination = "images/doctors/" . $fileNameNew;
      ...
      $qry = "update doctor set fullname='$tname',contactno='$contactno',gender='$gender',email='$temail',cname = '$tcname', caddress='$caddress',img='$fileNameNew' where did='$id'";
      $result = $cnn->query($qry);
      $yourURL = "Profile.php";
      echo ("<script>location.href='$yourURL'</script>");
    } else {
      $qry = "update doctor set fullname='$tname',contactno='$contactno',gender='$gender',email='$temail',cname = '$tcname', caddress='$caddress' where did='$id'";
      $result = $cnn->query($qry);
      if ($result) {
    ...
    <form role="form" method="POST" enctype="multipart/form-data"><br>
      ...
      <table style="width:100%;">
        ...
        <tr>
          <td>
            ...
            if (empty($img)) {
              ...
              echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/doctors/$img'>";
            }
            ?>
        ...
        <tr>
          ...
          <td><input type="text" class="form-control" id="fname" name="txtcname" value="<?php echo $cname; ?>">
            <span class="error"> <?php echo $gendererror; ?></span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td><textarea name="txtcaddress" class="form-control" id="fname" cols="10" rows="5" value=""><?php echo $caddr; ?></textarea>
