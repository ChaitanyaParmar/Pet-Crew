...
<div class="content-wrapper">
  ...
  $qry = "Select aid, fullname, status, petname, bname, appdate from appointment, breed where appointment.bid = breed.bid and gid = '$id' and status = '3'";
  ...
  if ($count > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      if (isset($_POST['btnDone'])) {
        $qry = "Update appointment set status='3',vdatetime=now() where aid='$aid' AND gid='$did'";
