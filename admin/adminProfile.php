...
<body>
  ...
  if (isset($_POST["btnsub"])) {
    ...
    if ($_FILES['file']['name'] != "") {
      ...
      if (in_array($fileActualExt, $allow)) {
        if ($fileError == 0) {
          if ($fileSize < 500000) {
            ...
            $fileDestination = "images/admin/" . $fileNameNew;
      ...
      $qry = "update admin set fullname='$tname',contactno='$contactno',gender='$gender',email='$temail',address='$address',img='$fileNameNew' where adminid='$id'";
      $result = $cnn->query($qry);
      $yourURL = "adminProfile.php";
      echo ("<script>location.href='$yourURL'</script>");
    } else {
      $qry = "update admin set fullname='$tname',contactno='$contactno',gender='$gender',email='$temail',address='$address' where adminid='$id'";
      $result = $cnn->query($qry);
      if ($result) {
      ...
      <table style="width:100%;">
        ...
        <tr>
          <td>
            ...
            <?php
            if (empty($img)) {
              echo "<img width='100px' height='90px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/logo/account.png'>";
            } else {
              echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/admin/$img'>";
            }
            ?>
          ...
          <td><label style="font-size:26px;margin-top:20px;"><?php echo $uname; ?></label><br><br>
            ...
            <?php
            echo "<a href='adminProfile_d.php?id=" . $id . "'>"; ?>
