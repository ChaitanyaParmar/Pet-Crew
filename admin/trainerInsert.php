        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            if (isset($_POST["btninsert"])) {
              ...
              $shop = $_POST["txtshop"];
              $role = $_POST["txtrole"];
              $qryInsert = "Insert into trainer (fullname, uname, contactno, gender, email, pwd, address, shop, role, doj) values('$name', '$username', '$contact', '$gender', '$email', '$pass', '$address', '$shop', '$role', now())";
            ...
            <form method="POST">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtshop" id="txtshop" placeholder="Enter Shop Name...">
                </div>
                <div class="form-group">
                  <input type="hidden" name="txtrole" value="3">
                </div>
              </div>
