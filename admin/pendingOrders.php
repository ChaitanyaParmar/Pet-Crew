  ...
  <div class="content-wrapper">
    <?php
      ...
      while($row=$result->fetch_assoc())
      {
        ...
        {
          $tbl.="<tbody><tr><td>$cnt</td><td>".$row["fullname"]."</td><td>".$row["ozip"]."</td><td>".$row["doo"]."</td><td><a href='orderDetails.php?id=".$row["oid"]."'><input type='submit' class='view' name='view' value='View Order'></a></td><td><a href='deliver.php?id=".$row["oid"]."'><input type='submit' class='deliver' name='deliver' value='Deliver'></a></td></tr></tbody>";
