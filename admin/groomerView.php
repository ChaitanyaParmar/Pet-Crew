  ...
  <div class="content-wrapper">
    <?php
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        $tbl .= "<tbody><tr><td>$name</td><td>$shop</td><td>$contact</td><td>$email</td><td><a href='groomerDetails.php?id=$id'><input type='submit' class='view' name='view' value='View'></a></td><td><a href='groomerDelete.php?id=$id'><input type='submit' class='delete' name='delete' value='Delete'></a></td></tr></tbody>";
      }
