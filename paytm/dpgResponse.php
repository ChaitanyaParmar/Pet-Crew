...
if($isValidChecksum == "TRUE") {
	...
	if ($_POST["STATUS"] == "TXN_SUCCESS") {
		...
		echo $query;
		$qry="select * from doctor where did='$did'";
        ...
        $body = "<html>
		<body>
			<p>Thank You <b>$fullname</b> For joining us.<br>Your $mname Plan of ₹<b>$TXN_AMOUNT</b> has been activated.<br>Now you can take <b>$mplimit</b> appointment under this plan.</p>
		</body>
		</html>";

        if (mail($to_email, $subject, $body, $headers)) {
			echo "<script>alert('Thank You! Your Payment is sucessful.');</script>";
			echo "<script>location.href='http://localhost:8080/pet/doctor/home.php'</script>";
