...
$qry1 = "select fullname from trainer where tid='$tid'";
...
//  }
    ...
    if ($flag == 0) {
        ...
        $qry = "insert into appointment(uid,fullname,contactno,address,bid,age,appdate,petname,details,tid,status) values('$uid','$tfname','$tcontact','$taddr','$tbid','$tpetage','$tadatetime','$tpname','$tcmt','$tid', '0')";
        ...
        $body = "<html>
         <body>
         <p><br>Dear " . $fname . ",
         <br><br>Your request of Trainer $fullname's appointment is appended. Please keep checking your mail for updates.<br>Thank You.<br>
         <br>~Pet Crew.</p>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 ">
                    ...
                    <div class="default-form">
                        <h2>MAKE AN APPOINTMENT <br><span style="font-size:15px;"><?php echo "Trainer :  $fullname</a>"; ?>
            </span></h2>
