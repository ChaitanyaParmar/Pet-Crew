...
<div class="col-12" class="card-body"><br>
    <form role="form" method="post" action="">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="slider">
                            <h2>GROOMER</h2>
                            <p> <a href="index.php">Home </a><span>/</span> <a href="services.php">Services</a> <span>/</span> <a href="groomer.php">Groomer</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="shop-section" style="padding-top: 30px;padding-bottom: 60px;">
            <div class="container">
                <h2 style="font-size:35px; font-weight:bold; font-family:Adobe Caslon Pro;text-decoration:underline; text-align:center; color: black; margin-bottom: 20px;">Groomer Details</h2>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $ans = $row["rate"];
                    $image = $row["img"];
                    $str .= "<tr class='row'><td class='izoom' style='border-top:3px solid black;'><img src='../groomer/images/groomers/$image' height='115' width='150' style='margin-left:40px; margin-top:20px;'><br><br>";
                    ...
                    <a href='trate.php?id=" . $row["gid"] . "&uid=" . $uid . "&rt=1'><i class='fa fa-star-o'  aria-hidden='true'></i></a>
                    <a href='trate.php?id=" . $row["gid"] . "&uid=" . $uid . "&rt=2'><i class='fa fa-star-o'  aria-hidden='true'></i></a>
                    <a href='trate.php?id=" . $row["gid"] . "&uid=" . $uid . "&rt=3'><i class='fa fa-star-o' aria-hidden='true'></i></a>
                    <a href='trate.php?id=" . $row["gid"] . "&uid=" . $uid . "&rt=4'><i class='fa fa-star-o'  aria-hidden='true'></i></a>
                    <a href='trate.php?id=" . $row["gid"] . "&uid=" . $uid . "&rt=5'><i class='fa fa-star-o'  aria-hidden='true'></i></a>

                    </li>

                    <a href='gappoint.php?id=" . $gid . "'>" . "
                ...
                if (isset($_POST["btnsub"])) {
                    ...
                    echo 'window.location="login.php?id=' . $gid . '";';
                    echo "</script>";
                }
