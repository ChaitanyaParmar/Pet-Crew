...
<section class="slider_area" style="background-image:url(images/slider/4.jpg);">
    ...
    <div class="content-wrapper" style='padding-left: 100px; padding-right: 100px; color: black; text-align: center; align-items: center'>
        <a href="acceptAppointment.php" style="font-size: 20px; border: 1px solid black; padding: 5px; color: black; border-radius: 5px;">Accepted</a>
        <a href="declineAppointment.php" style="font-size: 20px; border: 1px solid black; padding: 5px; color: black; border-radius: 5px; margin-left: 20px">Declined</a>
        <a href="completedAppointment.php" style="font-size: 20px; border: 1px solid black; padding: 5px; color: black; border-radius: 5px; margin-left: 20px">Completed</a>
        <a href="rescheduleAppointment.php" style="font-size: 20px; border: 1px solid black; padding: 5px; color: black; border-radius: 5px; margin-left: 20px">Reschedule</a> <br>
<?php
$conn = mysqli_connect("localhost", "root", "", "project");
$qry = "Select aid, appointment.fullname, petname, bname, status, appdate, did, gid, tid from appointment, breed where appointment.bid = breed.bid and uid = '$id'";
