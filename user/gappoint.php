...
$qry1 = "select fullname from groomer where gid='$gid'";
...
//  }
    ...
    if ($flag == 0) {
        ...
        $qry = "insert into appointment(uid,fullname,contactno,address,bid,age,appdate,petname,details,gid,status) values('$uid','$tfname','$tcontact','$taddr','$tbid','$tpetage','$tadatetime','$tpname','$tcmt','$gid', '0')";
        ...
        $body = "<html>
         <body>
         <p><br>Dear " . $fname . ",
         <br><br>Your request of Groomer $fullname's appointment is appended. Please keep checking your mail for updates.<br>Thank You.<br>
         <br>~Pet Crew.</p>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 ">
                    ...
                    <div class="default-form">
                        <h2>MAKE AN APPOINTMENT <br><span style="font-size:15px;"><?php echo "Groomer :  $fullname</a>"; ?>
            </span></h2>
                                    ...
                                    <div class="single-form">
                                        <div class="select-input-wrapper">
                                            <select class="select-input" name="txtpetage" style="padding-left: 10px; color: black;">
                                                ...
                                                <option value="1">Puppy (1-12 months)</option>
                                                <option value="2">Junior (1-2 years)</option>
                                                <option value="3">Adult (2-4 years)</option>
                                                <option value="4">Mature (4-7 years)</option>
                                                <option value="5">Senior (7-14 years)</option>
                                                <option value="6">Geriatric (more than 14 years)</option>
                                            </select>
                                        </div>
                                    </div>
