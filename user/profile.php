...
?>
    ...
    if (isset($_POST["btnsub"])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($_POST["txtcontact"])) {
                ...
                if (!preg_match("/^\d{10}$/", $contno1)) {
                    $noerror = "Please enter contactno of 10 digit";
                    $flag = 1;
                }
            }
        ...
        if ($_FILES['file']['name'] != "") {
            ...
            $qry = "update user set name='$tname',contact='$contactno',gender='$gender',email='$temail',address='$address',img='$fileNameNew' where uid='$id'";
            $result = $cnn->query($qry);
            $yourURL = "profile.php";
            echo("<script>location.href='$yourURL'</script>");
        } else {
            $qry = "update user set name='$tname',contact='$contactno',gender='$gender',email='$temail',address='$address' where uid='$id'";
            $result = $cnn->query($qry);
            if ($result) {
    ...
    <div class="card-body">
        <form role="form" method="POST" enctype="multipart/form-data"><br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider">
                                <h2>EDIT PROFILE</h2>
                                <p><a href="index.php">Home </a><span>/</span> <a href="profile.php">Profile</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        ...
                        <?php
                        if (empty($img)) {
                            echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/logo/account.png'>";
                        } else {
                            echo "<img width='180px' height='160px' style='border-radius:10%; position:relative; left:200px; top:-20px;'src='images/clients/$img'>";
                        }
                        ?>
                        <input id="f02" type="file" name="file"
                               style="position:relative; overflow:hidden; display:none;">
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" id="fname" name="txtemail"
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" id="fname" name="txtcontact"
                ...
                <tr>
                    ...
                    <td><textarea name="txtaddress" class="form-control" id="fname" cols="10" rows="5"
                                  value=""><?php echo $addr; ?></textarea>
            ...
            <div style="text-align:center;">
                ...
                <input type="submit" class="btn btn-primary" name="btnsub" style=" background:#231e1ee0;"
                       value="UPDATE">
