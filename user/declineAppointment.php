...
<div class="content-wrapper" style='padding-left: 100px; padding-right: 100px; color: black; text-align: center; align-items: center'>
    ...
    $qry = "Select aid, appointment.fullname, petname, bname, status, appdate, did, gid, tid from appointment, breed where appointment.bid = breed.bid and status = 2 and uid = '$id'";
